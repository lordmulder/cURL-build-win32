...
fetch_pkg "14d931fa98a329310dca7b190d047c3d4987674b1f466481f5490e4e12067ba4" "${PKGS_DIR}/curl.tar.gz"     https://curl.se/download/curl-${MY_VERSION}.tar.gz
