...
fetch_pkg "d15ebab765d793e2e96db090f0e172d127859d78ca6f6391d7eafecfd894bbc0" "${PKGS_DIR}/curl.tar.gz"     https://curl.se/download/curl-${MY_VERSION}.tar.gz
